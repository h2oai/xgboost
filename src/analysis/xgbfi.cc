...
void XgbModel::CollectFeatureInteractions(XgbTreePtr tree, InteractionPath* cfi,
  ...
  CollectFeatureInteractions(tree->left, &ipl, 0, 0, ppl, depth + 1, deepening, tfis, memo);
  CollectFeatureInteractions(tree->right, &ipr, 0, 0, ppr, depth + 1, deepening, tfis, memo);
}
